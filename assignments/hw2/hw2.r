...
plot(wr1500m$new_year, wr1500m$times_sec, type = "s", xlim = c(1892, 2030))
...
### 1. The data does not stands out, because almost all the points are clustered at the bottem left corner.
### 2. The plot does not faciliate comparisons, because we can recognize the relationship between x-axis and y-axis.
### 3. The plot is not information rich, because it has no clear caption or labels.
